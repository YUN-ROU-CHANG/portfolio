              ...
              <div className="two-column-layout">
                ...
                <div className="column-media" style={{ display: 'flex', flexDirection: 'column' }}>
                  <div className="image-wrapper shadow-box bg-white" style={{ flexGrow: 1, padding: '16px' }}>
                    <img src={getImage('problems')} alt={t('project.innoconnect.challenge.problemsAlt')} className="full-contain-img" />
                  </div>
                </div>
              </div>
          ...
          <div className="container" style={{ maxWidth: '1200px' }}>
            <div className="subsection">
              ...
              <div className="image-grid-3">
                <div className="image-wrapper shadow-box bg-white p-4"><img src={getImage('psychological-test')} alt={t('project.innoconnect.solution1.alt1')} /></div>
                <div className="image-wrapper shadow-box bg-white p-4"><img src={getImage('psychological-test-mockup-process')} alt={t('project.innoconnect.solution1.alt2')} /></div>
                <div className="image-wrapper shadow-box bg-white p-4"><img src={getImage('psychological-test-results')} alt={t('project.innoconnect.strategy.pillar1alt')} /></div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container" style={{ maxWidth: '1200px' }}>
            <div className="subsection">
              ...
              <div className="visual-showcase shadow-box mb-8" style={{ padding: '16px', background: '#fff' }}>
                <img src={getImage('sus+ueq')} alt={t('project.innoconnect.validation.overviewAlt')} className="full-contain-img" />
              </div>
                ...
                <div className="result-card sus-card">
                  ...
                  <div className="flex-col-gap-large">
                    <div className="image-wrapper shadow-box p-4 bg-white">
                      <img src={getImage('sus-chart')} alt={t('project.innoconnect.validation.susAlt1')} className="full-contain-img" />
                    </div>
                    <div className="image-wrapper shadow-box p-4 bg-white">
                      <img src={getImage('sus')} alt={t('project.innoconnect.validation.susAlt2')} className="full-contain-img" />
                    </div>
                  </div>
                </div>
            ...
            <div className="outcome-section">
              ...
              <div className="award-images-grid mt-12">
                <div className="image-wrapper shadow-box bg-white p-4">
                  <img src={getImage('InnoConnect+award-prove')} alt={t('project.innoconnect.impact.proofAlt')} className="full-contain-img" />
                </div>
                <div className="image-wrapper shadow-box bg-white p-4">
                  <img src={getImage('awards-report')} alt={t('project.innoconnect.impact.reportAlt')} className="full-contain-img" />
                </div>
              </div>
