...
* 日期格式各語言一套，不互相照抄（2026/09/16 使用者裁決）： 中文年在前，一律 `YYYY/MM` 並補零，同年區間 `2025/06 – 08`、跨年 `2024/10 – 2025/03`、只有年份 `2024 – 2026`； 英文月在前，`Sep 2025`，同年區間 `Jun – Aug 2025`、跨年 `Oct 2024 – Mar 2025`、只有年份 `2024 – 2026`。 區間一律用短破折號 `–` 前後加空格。內文敘述不受此限，可寫「2026 年 8 月畢業」。
...
* 我負責：團隊 11 場使用者訪談中的 3 場，以及痛點釐清，將色彩心理學轉譯為 10 種情緒光效系統；硬體與 AI 模型由組員負責
   * 訪談總數 11 場是團隊數字，Rose 本人執行 3 場。 禁止寫成「我主導 11 場訪談」或任何暗示 11 場都由 Rose 執行的說法。 （2026/09/20 使用者裁決，覆蓋先前誤記的 12 場。）
...
* 團隊 3 人（見企業提報「團隊成員」頁）：陳柏羽（心理測驗製作規劃、專案製作監督）、張韻柔（前端介面設計、企劃—流程改善規劃）、簡琦芸（前端介面設計、數據統計分析）。 心理測驗的「製作規劃」掛在組員名下，Rose 是提案者與流程設計者， 敘述時用「我提出／我用心理測驗當入口」，禁止寫成 Rose 製作心理測驗。
* 我負責：服務流程與前端介面設計（顧客旅程、服務藍圖、精實畫布），並提出評審點名的兩項核心創新，心理測驗社群裂變行銷與客製化互動賀卡
* 商業洞察：將「禮物逾期補差價」改為「未使用退回等值會員點數至會員帳號」，同時移除送禮心理負擔並把價值鎖回萊爾富生態（retention／LTV 思維）。 完整機制：有 Hi-Life VIP 才退點，沒有 VIP 則點數過期，藉此促使下載 APP。
* 成效驗證（數據一律以複賽計畫書「柒、概念驗證」為準，N=19，5 男 14 女，16 位 18–25 歲、3 位 26–35 歲）：
   * SUS：得分範圍 57.5–95。A 級（78–100）7 人 37%、B 級（72–77.9）5 人 27%、C 級（63–71.9）5 人 26%、D 級 1 人 5%、F 級 1 人 5%。 「90% 正面評價」＝ A＋B＋C 三級合計，不是「19 人中的 90%」，英文要寫成 `90% rated it positive on SUS (n=19)`。
   * UEQ：Pragmatic 1.250（Above average）、Hedonic 1.434（Good）、Overall 1.34（Good），三維度皆正向。
   * 心理測驗成效問卷：68% 提升想使用「來送禮」的意願、68% 因測驗結果想用「來送禮」送咖啡給朋友、**73% 是「對 Hi Cafe 與來送禮有更多的認識」**、47% 會想去買 Hi Cafe（另 47% 表示都可以）、63% 願意分享測驗結果、90% 以上認為測驗有吸引力且有趣、68% 認同測驗內容與咖啡有關聯。
   * 禁止寫成「73% 願試買 Hi Café」（2026/09/20 更正，先前誤把「提升認識 73%」當成「願試買」）。 企業提報長條圖的「嘗試買 Hi-cafe 94」是「想買 47%＋都可以 47%」的合併口徑，與計畫書不一致，一律不使用。
...
* 獎項兩項，彼此獨立，不可合併敘述（2026/09/17 使用者裁決，覆蓋先前的「文創畢業展第二名」寫法）：
   1. 苗栗縣政府「112 年農村青年創新好點子行動獎勵計畫」銅獎 （Bronze, Miaoli County Rural Youth Innovation Action Award, 2023）。 112 年即 2023 年，英文寫 2023。
   2. 專題競賽文創組第二名 （2nd Place, Project Competition, Creative Culture category）。
* 禁止寫成「文創畢業展」「Creative Culture Graduate Exhibition」，該名稱已作廢。
